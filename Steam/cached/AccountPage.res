"Steam/cached/AccountPage.res"
{
	layout {
		...
		place { control="ManageSecurityButton"			region=box dir=down start=Divider1 margin-top=19 }
		place { control="ChangePasswordButton"			region=box dir=down start=ManageSecurityButton }
		place { control="ChangeContactEmailButton"		region=box dir=down start=ChangePasswordButton }
		place { control="ValidateContactEmailButton"	region=box dir=down start=ChangeContactEmailButton } //only in offline mode

		place { control="NoPersonalInfoCheck"			region=box dir=down y=250 margin-top=10 }
		...
		place { control="ChangeBetaButton"				region=box dir=down start=CurrentBetaLabel margin-top=20 }
